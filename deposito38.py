...
Tenere questo file nella stessa cartella di deposito37.py. In assenza di quel
nome, il programma prova automaticamente altre versioni deposito*.py o app.py.
"""
...
def _trova_file_base() -> Path:
    ...
    raise FileNotFoundError(
        "Non trovo il file precedente. Metti deposito37.py nella stessa "
